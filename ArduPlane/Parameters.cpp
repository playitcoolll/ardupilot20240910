...
static const RCConversionInfo rc_option_conversion[] = {
    ...
    // { Parameters::k_param_rc_6_old, 0, RC_Channel::AUX_FUNC::K1},
    // { Parameters::k_param_rc_7_old, 0, RC_Channel::AUX_FUNC::K2},
    // { Parameters::k_param_rc_8_old, 0, RC_Channel::AUX_FUNC::K3},
    // { Parameters::k_param_rc_9_old, 0, RC_Channel::AUX_FUNC::K4},
