...
private:
    ...
    //刘老师让加的
    RC_Channel *channel_k1;
    RC_Channel *channel_k2;
    RC_Channel *channel_k3;
    RC_Channel *channel_k4;
    RC_Channel *channel_k5;
    RC_Channel *channel_k6;
    RC_Channel *channel_k7;
    uint32_t _last_AOA_update_ms_roll;
    uint32_t _last_AOA_update_ms_pitch;
    uint32_t _last_AOA_update_ms_pitch1;
