...
void Plane::set_control_channels(void)
{
    ...
    channel_k1    = RC_Channels::rc_channel(rcmap.k1()-1);
    channel_k2    = RC_Channels::rc_channel(rcmap.k2()-1);
    channel_k3    = RC_Channels::rc_channel(rcmap.k3()-1);
    channel_k4    = RC_Channels::rc_channel(rcmap.k4()-1);
    channel_k5    = RC_Channels::rc_channel(rcmap.k5()-1);
    channel_k6    = RC_Channels::rc_channel(rcmap.k6()-1);
    channel_k7    = RC_Channels::rc_channel(rcmap.k7()-1);
